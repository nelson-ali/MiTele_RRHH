...
class CargosController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $resolucionMinisterialOrganigrama = Resoluciones::findFirst(array("activo=1 and baja_logica=1 and (uso=1 or uso = 3)"));
        $this->view->setVar('organigrama_tipo_resolucion', $resolucionMinisterialOrganigrama->tipo_resolucion);
        $this->view->setVar('resolucion_ministerial_id', $resolucionMinisterialOrganigrama->id);
        $this->tag->setDefault("resolucion_ministerial_id", $resolucionMinisterialOrganigrama->id);
        ...
        $resolucionMinisterialEscala = $this->tag->select(
            array(
                'id_resolucion_escala',
                Resoluciones::find(array('activo = 1 AND uso=2 and baja_logica=1', "order" => "id ASC")),
                'using' => array('id', "tipo_resolucion"),
                'useEmpty' => true,
                'emptyText' => '(Seleccionar)',
                'emptyValue' => '',
        ...
        $this->view->setVar('resolucion_escala', $resolucionMinisterialEscala);

        $resolucionMinisterialEscala = $this->tag->select(
            array(
                'resolucion_escala_id',
                Resoluciones::find(array('activo = 1 AND baja_logica = 1 AND (uso = 2 OR uso = 3)', "order" => "id ASC")),
                'using' => array('id', "tipo_resolucion"),
                'useEmpty' => true,
                'emptyText' => '(Seleccionar)',
                'emptyValue' => '',
        ...
        $this->view->setVar('resolucion_ministerial_escala', $resolucionMinisterialEscala);
        $this->defineViewCols();
    }
    /**
    ...
    private function defineViewCols()
    {
        ...
        $listaDeColumnas = array(
            "hdnResolucionOrganigrama", "hdnResolucionEscala", "hdnUnidadOrganizacional", "hdnDenominacion", "hdnOrdenador", "hdnCargo",
            "hdnSalario", "hdnItem", "hdnEstado", "hdnCondicion", "hdnPartida", "hdnCodFuente", "hdnCodOrganismo", "hdnGestion"
        );
        ...
        $objGrillaDetallePae = Columnasvisibles::findFirst("divgrilla_id='divGrillaCargos' AND user_id=" . $idUsuario);
    ...
    /**
     * Función para la obtención del listado paginado de cargos.
     */
    public function listAction()
    {
        ...
        $model = new Cargos();
        //$resul = $model->lista($where, $orderby, $limit);
        $resul = $model->getPaged(0,0,0,0, $where, $orderby,$start, $pagesize);
        $customers = array();
        if(count($resul)>0){
            foreach ($resul as $v) {
                ...
                $customers[] = array(
                    'id' => $v->id,
                    'organigrama_resolucion_ministerial_id' => $v->organigrama_resolucion_ministerial_id,
                    'organigrama_tipo_resolucion' => $v->organigrama_tipo_resolucion,
                    'escala_resolucion_ministerial_id' => $v->escala_resolucion_ministerial_id,
                    'escala_tipo_resolucion' => $v->escala_tipo_resolucion,
    ...
    public function saveAction()
    {
        if (isset($_POST['id'])) {
            $auth = $this->session->get('auth');
            $modelNS = Nivelsalariales::findFirstById($_POST['codigo_nivel']);
            $resolucion_ministerial_id = $modelNS->resolucion_id;
            if ($_POST['id'] > 0) {
                ...
                $resul->resolucion_ministerial_id = $resolucion_ministerial_id;// $_POST['resolucion_ministerial_id'];
    ...
    /**
     * Función para obtener el listado PAC-PERSONAL paginado.
     */
    public function listpacpagedAction()
    {
        $where = "";
        $pagenum = $_GET['pagenum'];
        $pagesize = $_GET['pagesize'];
        ...
        $model = new Cargos();
        $resul = $model->getPacPaged(0,0,0,0, $where, $orderby,$start, $pagesize);
        $this->view->disable();
        $total_rows = 0;
        if(count($resul)>0){
            foreach ($resul as $v) {
    ...
    /**
     * Función para obtener la lista de valores filtrables.
     */
    public function getfiltersAction()
    {
        ...
        $obj = new Cargos();
        $resultado["resoluciones"] = $obj->getFiltroResolucion();
        $resultado["organigramas"] = $obj->getFiltroOrganigrama();
        $resultado["gestiones"] = $obj->getFiltroGestiones();
        $resultado["condiciones"] = $obj->getFiltroTipoCargo();
        echo json_encode($resultado);
    }

    /**
     * Función para la exportación a excel del reporte de cargos
     * @param $n_rows
     * @param $columns
     * @param $filtros
     * @param $groups
    ...
    public function exportarExcelAction($n_rows, $columns, $filtros, $groups, $sorteds)
    {
        ...
        $generalConfigForAllColumns = array(
            ...
            'organigrama_tipo_resolucion' => array('title' => 'Resolución (Org)', 'width' => 40, 'align' => 'L', 'type' => 'varchar'),
            'escala_tipo_resolucion' => array('title' => 'Resolución (Esc)', 'width' => 40, 'align' => 'L', 'type' => 'varchar'),
            'unidad_administrativa' => array('title' => 'Organigrama', 'width' => 35, 'align' => 'C', 'type' => 'varchar'),
            'denominacion' => array('title' => 'Denominación', 'width' => 30, 'align' => 'R', 'type' => 'varchar'),
            'ordenador' => array('title' => 'Ordenador', 'width' => 10, 'align' => 'R', 'type' => 'varchar'),
            'cargo' => array('title' => 'Cargo', 'width' => 35, 'align' => 'R', 'type' => 'varchar'),
            'sueldo' => array('title' => 'Sueldo Bs.', 'width' => 18, 'align' => 'L', 'type' => 'int4'),
            'codigo' => array('title' => 'Item', 'width' => 10, 'align' => 'L', 'type' => 'varchar'),
            'estado' => array('title' => 'Estado', 'width' => 20, 'align' => 'R', 'type' => 'bpchar'),
            'condicion' => array('title' => 'Tipo Cargo', 'width' => 20, 'align' => 'R', 'type' => 'varchar'),
            ...
            'organismo_codigo' => array('title' => 'Organismo Codigo', 'width' => 20, 'align' => 'L', 'type' => 'int4'),
            'organismo' => array('title' => 'Organismo', 'width' => 20, 'align' => 'R', 'type' => 'varchar'),
            'gestion' => array('title' => 'Gestion', 'width' => 20, 'align' => 'L', 'type' => 'int4')
        );
        ...
        if (count($widthsSelecteds) > 0) {
            ...
            $resul = $obj->getPaged(0,0,0,0,$where, $groups,0,0);
            $cargos = array();
            foreach ($resul as $v) {
                $cargos[] = array(
                    'organigrama_tipo_resolucion' => $v->organigrama_tipo_resolucion,
    ...
    /**
     * Función para la exportación a pdf del reporte de cargos.
     * @param $n_rows
     * @param $columns
     * @param $filtros
     * @param $groups
    ...
    public function exportarPdfAction($n_rows, $columns, $filtros, $groups, $sorteds)
    {
        ...
        $generalConfigForAllColumns = array(
            'nro_row' => array('title' => 'Nro.', 'width' => 7, 'title-align' => 'C', 'align' => 'C', 'type' => 'int4'),
            'organigrama_tipo_resolucion' => array('title' => 'Resolución (Organigrama)', 'width' => 40, 'align' => 'L', 'type' => 'varchar'),
            'escala_tipo_resolucion' => array('title' => 'Resolución (Escala)', 'width' => 40, 'align' => 'L', 'type' => 'varchar'),
            'unidad_administrativa' => array('title' => 'Organigrama', 'width' => 35, 'align' => 'L', 'type' => 'varchar'),
            'denominacion' => array('title' => 'Denominación', 'width' => 30, 'align' => 'L', 'type' => 'varchar'),
            'ordenador' => array('title' => 'Ord', 'width' => 10, 'align' => 'C', 'type' => 'varchar'),
            'cargo' => array('title' => 'Cargo', 'width' => 35, 'align' => 'L', 'type' => 'varchar'),
            'sueldo' => array('title' => 'Sueldo Bs.', 'width' => 18, 'align' => 'R', 'type' => 'int4'),
            'codigo' => array('title' => 'Item', 'width' => 10, 'align' => 'C', 'type' => 'varchar'),
            'estado' => array('title' => 'Estado', 'width' => 20, 'align' => 'L', 'type' => 'bpchar'),
            'condicion' => array('title' => 'Tipo Cargo', 'width' => 20, 'align' => 'L', 'type' => 'varchar'),
            'partida' => array('title' => 'Partida', 'width' => 15, 'align' => 'R', 'type' => 'int4'),
            'fuente_codigo' => array('title' => 'Fnt-Cod', 'width' => 15, 'align' => 'R', 'type' => 'int4'),
            'fuente' => array('title' => 'Fuente', 'width' => 20, 'align' => 'R', 'type' => 'varchar'),
            'organismo_codigo' => array('title' => 'Org-Cod', 'width' => 15, 'align' => 'R', 'type' => 'int4'),
            'organismo' => array('title' => 'Organismo', 'width' => 20, 'align' => 'R', 'type' => 'varchar'),
            'gestion' => array('title' => 'Gestion', 'width' => 15, 'align' => 'C', 'type' => 'int4')
        );
     ...
     * @param $sorteds
     */
    public function exportarPacExcelAction($n_rows, $columns, $filtros, $groups, $sorteds)
    {
        $columns = base64_decode(str_pad(strtr($columns, '-_', '+/'), strlen($columns) % 4, '=', STR_PAD_RIGHT));
        $filtros = base64_decode(str_pad(strtr($filtros, '-_', '+/'), strlen($columns) % 4, '=', STR_PAD_RIGHT));
        $groups = base64_decode(str_pad(strtr($groups, '-_', '+/'), strlen($groups) % 4, '=', STR_PAD_RIGHT));
        ...
        $generalConfigForAllColumns = array(
            'nro_row' => array('title' => 'Nro.', 'width' => 7, 'title-align' => 'C', 'align' => 'C', 'type' => 'int4'),
            'organigrama_tipo_resolucion' => array('title' => 'Resolución (Organigrama)', 'width' => 45, 'align' => 'J', 'type' => 'varchar'),
            'escala_tipo_resolucion' => array('title' => 'Resolución (Escala)', 'width' => 45, 'align' => 'J', 'type' => 'varchar'),
            'unidad_administrativa' => array('title' => 'Unidad Organizacional', 'width' => 45, 'align' => 'J', 'type' => 'varchar'),
        ...
        if (count($widthsSelecteds) > 0) {
            ...
            #region Proceso de generación del documento Excel
            $excel->debug = 0;
            $excel->title_rpt = utf8_decode('Reporte de PAC - Personal');
            $excel->header_title_empresa_rpt = utf8_decode('Empresa Estatal de Transporte por Cable "Mi Teleférico"');
            $alignSelecteds = $excel->DefineAligns($generalConfigForAllColumns, $columns, $agruparPor);
            $colSelecteds = $excel->DefineCols($generalConfigForAllColumns, $columns, $agruparPor);
            $colTitleSelecteds = $excel->DefineTitleCols($generalConfigForAllColumns, $columns, $agruparPor);
            ...
            //$resul = $obj->getPaged(0,0,0,0,$where, $groups,0,0);
            $resul = $obj->getPacPaged(0,0,0,0, $where, "",0, 0);
            $cargos = array();
            foreach ($resul as $v) {
                $cargos[] = array(
                    'organigrama_tipo_resolucion' => $v->organigrama_tipo_resolucion,
            ...
            //$excel->secondPage();
            if ($excel->debug == 0) {
                $excel->display("AppData/reporte_pac_personal.xls", "I");
            }
            #endregion Proceso de generación del documento PDF
        }
    }
    /**
     * Función para la exportación a pdf del reporte PAC de personal.
     * @param $n_rows
     * @param $columns
     * @param $filtros
     * @param $groups
    ...
    public function exportarPacPdfAction($n_rows, $columns, $filtros, $groups, $sorteds)
    {
        ...
        if (count($widthsSelecteds) > 0) {
            ...
            $resul = $obj->getPacPaged(0, 0,0,0,$where, $groups,0,0);
            $cargos = array();
            foreach ($resul as $v) {
                $cargos[] = array(
                    'organigrama_tipo_resolucion' => $v->organigrama_tipo_resolucion,
            ...
            $pdf->ShowLeftFooter = true;
            if ($pdf->debug == 0) $pdf->Output('reporte_pac_personal.pdf', 'I');
            #endregion Proceso de generación del documento PDF
        }
...
// 	}
    ...
    public function select_finpartidasAction()
    {
        $resul = Finpartidas::find(array('baja_logica=1', 'order' => 'id desc '));
        $this->view->disable();
        $options = '<option value="">(Seleccionar)</option>';
        foreach ($resul as $v) {
            $checked = '';
    ...
    public function select_resoluciones_escalaAction()
    {
        $resul = Resoluciones::find(array('uso = 2 AND baja_logica=1', 'order' => 'id ASC'));
        $this->view->disable();
        $options = '<option value="">(Seleccionar)</option>';
        foreach ($resul as $v) {
            $options .= '<option value="' . $v->id . '">' . $v->tipo_resolucion . ' </option>';
        }
        echo $options;
    }
    public function select_escalaAction()
    {
        $idResolucion = ($_POST['id_r']>0)?$_POST['id_r']:0;
        $resul = Nivelsalariales::find(array('baja_logica=1 AND resolucion_id = '.$idResolucion, 'order' => 'id ASC'));
        $this->view->disable();
        $options = '<option value="">(Seleccionar)</option>';
        foreach ($resul as $v) {
            $options .= '<option value="' . $v->id . '">' . $v->denominacion . '  (Bs'.$v->sueldo.') </option>';
        }
        echo $options;
    }
