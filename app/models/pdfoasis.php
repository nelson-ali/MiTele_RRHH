...
class pdfoasis extends fpdf
{
    ...
    function Header()
    {
        $this->Image('../public/images/escudo.jpg', 10, 10, 20, 0);
        $x_segunda_imagen = $this->pageWidth - 25;
        $this->Image('../public/images/logoMT.jpg', $x_segunda_imagen, 10, 15, 0);
    ...
    function Body($tempDir, $objR, $objCe, $objCorr, $objExcRip)
    {
        ...
        $this->MultiCell(68, 5, utf8_decode($departamentoAdministrativo !== '' ? $departamentoAdministrativo : ""), 0, 'J', false);
